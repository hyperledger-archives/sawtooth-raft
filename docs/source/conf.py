...
htmlhelp_basename = 'SawtoothRaftDoc'
...
latex_documents = [
    (master_doc, 'sawtooth.tex', u'Sawtooth Raft Documentation',
...
man_pages = [
    (master_doc, 'intel', u'Sawtooth Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SawtoothRaft', u'Sawtooth Documentation',
     author, 'SawtoothRaft', 'One line description of project.',
     'Miscellaneous'),
]
